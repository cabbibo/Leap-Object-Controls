...
function Loader(  params ){
  ...
  Loader.prototype = {
    ...
    addToLoadBar: function(string){

      //console.log( 'Begin Loading: ' + string );
    ...
    loadBarAdd: function( string ){

     
      //console.log( 'End Loading: ' + string );
    ...
    loadShader: function( title , shader, type) {

          this.beginLoad( title );
          var self = this;
          ...
          $.ajax({
              ...
              complete: function(r){
                self.loadBarAdd( title );
                if( type == 'vertex' ){
                  vs[title] = r.responseText;
                  self.loadedShaders.vs[title] = r.responseText
                }else{
                  fs[title] = r.responseText;
                  self.loadedShaders.fs[title] = r.responseText
  ...
  // Some additional handles
  Loader.prototype.beginLoad = Loader.prototype.addToLoadBar;
  Loader.prototype.endLoad = Loader.prototype.loadBarAdd;
